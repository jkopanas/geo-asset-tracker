...
import type { AssetType, AssetStatus, BBox, Asset, AssetListResponse } from '@shared/types.js';
import { getAsset } from '../lib/api.js';

type Filters = { type: AssetType[]; status: AssetStatus[] };

export function useAsset(id: string | null, filters: Filters, bbox: BBox | undefined) {
